...
{
    public class EuropeanOption: Simulator
    {
        ...
        public double BS_delta(European O, double j, double S)
        {
                double d1 = 0.0;
                double delta_bs = 0.0;
        ...
        public (double VP, double std) OptionPandStd(European O)
        {
                ...
                if (O.S.IsAntithetic == false)
                {
                    ...
                    {   
                        ...
                        {   
                            ...
                            CT = Math.Max(0, St - O.Strike) + beta1*CV;
                            sum_VT = sum_VT + CT;
                        ...
                        else if (O.IsCall == false)
                        {
                            ...
                            PT = Math.Max(0,  O.Strike - St) + beta1*PV;
                            sum_VT = sum_VT + PT;
                ...
                if (O.S.IsAntithetic == true)
                {
                    ...
                    {   
                        ...
                        {   
                            ...
                            CT = 0.5* (Math.Max(0, St - O.Strike) + beta1*CV + Math.Max(0, St_2 - O.Strike) + beta1*CV_2);
                            sum_VT = sum_VT + CT;
                            sum_VT2 = sum_VT2 + CT*CT;
                        }
                        else if (O.IsCall == false)
                        {
                            ...
                            PT = 0.5* (Math.Max(0, O.Strike - St) + beta1*PV + Math.Max(0,  O.Strike - St_2) + beta1*PV_2);
                            sum_VT = sum_VT + PT;
                            sum_VT2 = sum_VT2 + PT * PT;
                        }
            ...
            else if (O.S.IsDeltaCV == false)
            {
                for (int i = 0; i < O.S.Simulations; i++)
                {
                    if (O.IsCall == true)
                    {   
                        eachOption.Add(Math.Max(SpathNorm.SimulatedPaths[i, O.S.Steps - 1]-O.Strike, 0));
                    }
                
                    else if (O.IsCall == false)
                    {
                        eachOption.Add(Math.Max(O.Strike - SpathNorm.SimulatedPaths[i, O.S.Steps - 1], 0));
                    }
        ...
        public double StandardError(European O, bool IsAnti)
        {
            double SE = new double();
            European O1 = new European();
        ...
        public (double Delta, double Gamma) DeltaandGamma(European O)
        {
            double deltaS = 0.1;
            double Delta = new double();
            double Gamma = new double();
            European O1 = new European();
            European O2 = new European();
            SimulationParameters S1 = new SimulationParameters();
        ...
        public double VegaValue(European O)
        {
        ...
        public double ThetaValue(European O)
        {
            double deltaT = 0.01;
        ...
        public double RhoValue(European O)
        {
